...
static const char *NOMBRES[] = {
    "Francisco", "Lucia", "Martin", "Rocio", "Celeste", "Gustavo", "Luis", "Marta", "Juan", "Sofia", "Pedro", "Ana", "Diego", "Clara"};
static const size_t CANT_NOMBRES = sizeof(NOMBRES) / sizeof(NOMBRES[0]);

void semilla_randrec(void)
{ // llamar una vez al inicio de cada proceso
